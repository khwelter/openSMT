...
class VisionPipelineDialog(QDialog):
    ...
    def __init__(self, api: ControlApiClient, base_url: str, parent: QWidget | None = None) -> None:
        ...
        self._width_mm.setMaximumWidth(110)
        self._length_mm.setMaximumWidth(110)
        size_row = QWidget()
        size_row_layout = QHBoxLayout(size_row)
        size_row_layout.setContentsMargins(0, 0, 0, 0)
        size_row_layout.setSpacing(4)
        size_row_layout.addWidget(self._width_mm)
        size_row_layout.addWidget(QLabel("x"))
        size_row_layout.addWidget(self._length_mm)
        meta_row.addWidget(QLabel("Pipeline name"))
        meta_row.addWidget(self._name, 1)
        meta_row.addWidget(QLabel("Size W x L (mm)"))
        meta_row.addWidget(size_row)
        meta_row.addStretch(1)
        meta_box.setMaximumHeight(72)
