...
I do believe, however, that AI is here to stay. And that's why I have decided to start writing - or better better - orchestratimg my own interpretation of an pick and place machine S/W.

#Status

openSMT ist far away from being a working S/W. Up 'til now I got the backend working and some kind of frontend.
Backend???? Wait ... why backend???
Well, this is mostly due to my development setup. My machine ist located in the basement, which is still some kind of construction zone (construction as in building construction) and doesn't have a convenient office desk, office chair ... you name it.
