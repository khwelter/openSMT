...
mkdir -p "${PROJECT_NAME}/pipelines"
...
touch "${PROJECT_NAME}/pipelines/default.json"
touch "${PROJECT_NAME}/pipelines/grayscale_threshold.json"
touch "${PROJECT_NAME}/pipelines/edge_detection.json"
